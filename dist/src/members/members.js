...
exports.memberRouter.get('/searchmember/:seachPhrase', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const memberSeachPhrase = req.params.seachPhrase;
        const member = yield (0, memberService_1.searchMembers)(memberSeachPhrase);
        if (member) {
            res.json(member);
        }
        else {
