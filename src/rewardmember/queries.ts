...
export const getAllRewardMembersQuery = `SELECT
...
export const createRewardMemeberQuery = `INSERT INTO dbo.member_rewards
(member_id,
reward_id,
reward_active)
VALUES
...
export const updateRewardMemeberQuery = `update  member_rewards 
set 
